    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Data Produk Dapur Bujalu</h6>
            </div>
    <div class="card-body">
        <?php foreach ($toko_bujalu as $to) : ?>
            <form method="POST" action="<?php echo base_url('index.php/dapur_bujalu/updateDataAksi'); ?>">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo base_url().'assets/img/dapur_bujalu/'.$to->foto_produk ?>" width="90" height="110">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url();?>index.php/dapur_bujalu">Cancel</a>
                </form>
                <?php endforeach; ?> 
            </div>
        </div>               
