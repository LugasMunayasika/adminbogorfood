    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="<?php echo base_url().'dapur_bujalu/tambahData/' ?>" class="btn btn-success"><i class="fa fa-plus">Tambah Data</i></a><hr> 
                ...
                <div class="table-responsive" >
                    ...
                    <?php $no=1; foreach($dapur_bujalu as $d) :  ?>
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-sm btn-success" href="<?php echo base_url('dapur_bujalu/detail/' .$d->id_produk)?>"><i class="fas fa-search-plus"></i></a>
                                <a class="btn btn-sm btn-primary" href="<?php echo base_url('dapur_bujalu/updateData/' .$d->id_produk)?>"><i class="fas fa-edit"></i></a>
                                <a onclick="return confirm('Yakin hapus data ini?')" class="btn btn-sm btn-danger" href="<?php echo base_url('dapur_bujalu/deleteData/'.$d->id_produk)?>"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                    <?php endforeach; ?>
                        </tbody>
