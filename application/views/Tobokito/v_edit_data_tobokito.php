    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Data Produk Toko Tobokito</h6>
            </div>
    <div class="card-body">
        <?php foreach ($toko_tobokito as $to) : ?>
            <form method="POST" action="<?php echo base_url('index.php/tobokito/updateDataAksi'); ?>">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo base_url().'assets/img/tobokito/'.$to->foto_produk ?>" width="90" height="110">
